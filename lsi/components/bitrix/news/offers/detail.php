...
<?
if(!empty($GLOBALS['ARTICLE_PRODUCTS'])){
	$GLOBALS['arFilterRecomendation'] = array(
		'ID' => $GLOBALS['ARTICLE_PRODUCTS']
	);
	$GLOBALS['class_for_information'] = 'mbn';
	?>
	<div class="h2 pbl">Товары по акции</div>
	<?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"FILTER_NAME" => "arFilterRecomendation",
