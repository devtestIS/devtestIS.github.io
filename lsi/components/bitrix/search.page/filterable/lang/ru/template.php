...
$MESS["INTERVOLGA_CUSTOM.PRODUCTS_FOUND"] = "По запросу &laquo;#QUERY#&raquo; найдено товаров: #COUNT#";
$MESS["INTERVOLGA_CUSTOM.PRODUCTS_FOUND_FILTERED"] = "По запросу &laquo;#QUERY#&raquo; найдено товаров: #COUNT# (показано #CURRENT#)";
$MESS["INTERVOLGA_CUSTOM.USE_SEARCH_FORM"] = "Воспользуйтесь формой в шапке сайта для поиска по товарам";
$MESS["INTERVOLGA_CUSTOM.NO_SMART_FILTER_RESULT"] = "Администратору: Компонент умного фильтра сгенерировал пустой фильтр (в выдаче окажутся все товары каталога). Возможно, у товаров не заполнено свойство ID.";