...
if (!empty($arResult['ITEMS'])){
	foreach ($arResult['ITEMS'] as $key => $arItem) {
		...
		<div class="card-product-line" id="<?=$strMainID?>">
			...
			<a class="card-product-line__img" href="<?=$arItem['DETAIL_PAGE_URL']?>">
			...
			<div class="card-product-line__control">
				<div class="card-product-line__label card-product-line__label_type_<?= $arItem['LABELS']['AVAILABILITY']['VIEW'] ? 'availability' : 'not-available' ?>">
					<?= $arItem['LABELS']['AVAILABILITY']['VIEW'] ? 'В наличии' : 'Под заказ' ?>
				</div>
				<div class="card-product-line__price<? if($arItem['MIN_PRICE']['DISCOUNT_VALUE'] != $arItem['MIN_PRICE']['VALUE']){ ?> card-product-line__price_new<? } ?>">
