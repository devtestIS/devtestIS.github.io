...
{
	// Сам компонент все равно не кешируется :(
	...
	$props = array_diff($props, \Intervolga\Custom\Product::getMarkerPropCodes());
	$props = array_intersect($props, $arParams["COMPARE_PROPERTY_CODE"]);
}
?>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		'FAT_PROPERTIES' => array('KOMPLEKTATSIYA')
	),
	$component,
	array("HIDE_ICONS" => "Y")
);?>
...
if ($request->getQuery("action") == "DELETE_FROM_COMPARE_RESULT" && $request->getQuery("ID"))
{
