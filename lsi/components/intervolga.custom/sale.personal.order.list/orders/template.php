				...
				<div class="order-item__body">
					<div class="order-item__row">
						...
						<div class="order-item__col order-item__col_column_four">
							...
							?>
							<?if($order["ORDER"]["DELIV_SERV"] && $order["ORDER"]["TRACKING_NUMBER"] != ""):?>
								<br> № <a href="<?= $order["ORDER"]["DELIV_SERV"]["LINK"]?>"><?= $order["ORDER"]["TRACKING_NUMBER"]?></a>
							<?endif;?>
						</div>
					</div>
					<div class="order-item__row">
						<div class="order-item__col order-item__col_column_one"></div>
						<div class="order-item__col order-item__col_column_two"></div>
						<div class="order-item__col order-item__col_column_three"></div>
						<div class="order-item__col order-item__col_column_four"></div>
					</div>
					<div class="order-item__row">
