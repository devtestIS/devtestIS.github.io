...
$arParams['TEMPLATE_COUNT_FEATURES'] = $arParams['TEMPLATE_COUNT_FEATURES'] ?: 5;
$arParams['TEMPLATE_MAX_COUNT_IN_NORMAL_NUMBER'] = $arParams['TEMPLATE_MAX_COUNT_IN_NORMAL_NUMBER'] ?: 6;
...
foreach ($arResult["ITEMS"] as &$item) {
    ...
    $item['SHOWCASE'] = \Intervolga\Custom\Product::getShowCase($item, $arParams['TEMPLATE_COUNT_FEATURES']);
    ...
    $item['LABELS'] = array(
	    ...
	    'HIT' => array(
            'VIEW' => in_array('OUR_CHOICE', $arParams['VIEW_LABEL'])
                && $item['PROPERTIES']['KHIT_PRODAZH_']['VALUE_XML_ID'] == 'true',
            'NAME' => 'Хит продаж',
            'TYPE' => 'hit'
        ),
        'GUARANTEE' => array(
