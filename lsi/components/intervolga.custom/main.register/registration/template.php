...
if ($USER->IsAuthorized()) {
    ...
    ?>
    <form method="post" action="<?=POST_FORM_ACTION_URI?>" name="lsiregform">
        <?
        if ($arResult["BACKURL"] <> '') {
            ?>
        ...
        <div class="form-group clearfix">
            <label for="REGISTER_EMAIL" class="col-sm-3 control-label"><?=GetMessage("R_REGISTER_FIELD_EMAIL")?><sup class="text-danger">*</sup></label>
            <div class="col-sm-9">
                <input type="hidden"
                       id="REGISTER_LOGIN"
                       name="REGISTER[LOGIN]"
        ...
        <div class="form-group clearfix">
            <label for="REGISTER_PASSWORD" class="col-sm-3 control-label"><?=GetMessage("R_REGISTER_FIELD_PASSWORD")?><sup class="text-danger">*</sup></label>
            <div class="col-sm-9">
                <input type="password"
                       class="form-control"
        ...
        <div class="form-group clearfix">
            <label for="REGISTER_CONFIRM_PASSWORD"
                   class="col-sm-3 control-label"><?=GetMessage("R_REGISTER_FIELD_CONFIRM_PASSWORD")?><sup class="text-danger">*</sup></label>
            <div class="col-sm-9">
                <input type="password"
                       class="form-control"
        ...
        <div class="form-group clearfix">
            <div class="col-sm-offset-3 col-md-3 col-sm-9">
                <input class="btn btn-primary btn-block mbs" type="submit" name="register_submit_button"
