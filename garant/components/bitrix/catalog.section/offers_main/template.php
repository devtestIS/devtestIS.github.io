		...
		<div class="col-xs-12" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
			<div class="thumbnails thumbnails_type_offer">
				<div class="thumbnails__image">
					...
					<?endif;?>
					<?if (isset($arResult["ELEMENTS_PARENT_SECTIONS"][$arItem['ID']]) && !empty($arResult["ELEMENTS_PARENT_SECTIONS"][$arItem['ID']])):?>
				...
				<div class="thumbnails__caption">
					<div class="thumbnails__control">
						...
						<?endif;?>
						<button class="btn btn_color_border-primary" type="submit" href="javascript:void(0)" data-proposals='offers' data-offer-link="<?= $arItem['DETAIL_PAGE_URL']?>"><?= GetMessage('CATALOG_SECTION_OFFERS_BUTTON')?></button>
					</div>
