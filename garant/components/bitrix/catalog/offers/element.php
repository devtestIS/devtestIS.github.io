...
$isOffers = $request->getQuery('offers') == 'Y';
?><div class="sticky row"><?
include 'include/sidebar.php';
    if ($isOffers)
    {
        include 'include/companyoffers.php';
    }
    else
    {
        $elementId = $APPLICATION->IncludeComponent(
            ...
            array(
	            ...
	            'ELEMENT_PROPERTY_CODE' => $arParams['ELEMENT_PROPERTY_CODE'],
	            'COMPANY_PROPERTY_CODE' => $arParams['COMPANY_PROPERTY_CODE'],
