...
+function(t){function n(n){return this.each(function(){var i=t(this),l=i.data("block.main_nav"),e="object"==typeof n&&n;l||i.data("block.main_nav",l=new o(this,e)),"string"==typeof n&&l[n]()})}var o=function(t,n){this.$block=null,this.$toggle=null,this.init(t,n)};o.prototype.init=function(n,o){this.$block=t(n),this.$toggle=this.$block.find(".main-nav__toggle"),t(document).on("click",t.proxy(this.toggle,this))},o.prototype.toggle=function(n){var o=t(n.target);o.closest(this.$block).length||this.$block.removeClass("open"),o.closest(this.$toggle).length&&this.$block.toggleClass("open")},t.fn.block_main_nav=n,t.fn.block_main_nav.Constructor=o,t(".main-nav").block_main_nav()}(jQuery);
+function(i){function t(t){return this.each(function(){var s=i(this),n=s.data("block.main"),l="object"==typeof t&&t;n||s.data("block.main",n=new o(this,l)),"string"==typeof t&&n[t]()})}var o=function(i,t){this.$block=null,this.$up=null,this.$upText=null,this.scrollPosition=null,this.ticking=!1,this.init(i,t)};o.prototype.init=function(t,o){this.$body=i("body,html"),this.$block=i(t),this.$up=this.$block.find(".main__up"),this.$upText=this.$block.find(".main__up-text"),this.$up.on("click",i.proxy(function(t){this.ticking=!0,this.$upText.css({position:"absolute"}),this.$up.css({visibility:"visible",opacity:0}),this.$body.animate({scrollTop:0},0,i.proxy(function(){this.ticking=!1,window.requestAnimationFrame(i.proxy(function(){this.onScroll(t),this.ticking=!1},this))},this)),t.preventDefault()},this)),i(window).on("resize scroll load",i.proxy(function(t){var o=t.type;"load"==o&&this.$up.css({visibility:"visible"}),"scroll"==o&&(this.scrollPosition=window.scrollY),this.ticking||window.requestAnimationFrame(i.proxy(function(){this.onScroll(t),this.ticking=!1},this)),this.ticking=!0},this))},o.prototype.onScroll=function(){this.align=this.scrollPosition+window.innerHeight<this.$up.offset().top+this.$up.outerHeight(),this.position=this.scrollPosition>this.$up.offset().top,this.opacity=this.scrollPosition>this.$up.offset().top+window.innerHeight/2,this.$upText.css({position:this.position&&this.align?"fixed":"absolute"}),this.$up.css({visibility:"visible",opacity:this.position&&this.opacity?1:0})},i.fn.block_main=t,i.fn.block_main.Constructor=o,i(".main").block_main()}(jQuery);
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
/ __| | |/ __| |/ /  | / __|
...
document.addEventListener("OnDocumentHtmlChanged",function(){$("#select-cities").length&&$("#select-cities").selectize({plugins:["remove_button"],delimiter:","})},!1);
/**
 * sifter.js
...
+function(t){function c(c){return this.each(function(){var o=t(this),h=o.data("block.switch"),n="object"==typeof c&&c;h||o.data("block.switch",h=new i(this,n)),"string"==typeof c&&h[c]()})}var i=function(t,c){this.$block=null,this.$checkbox=null,this.$radio=null,this.init(t,c)};i.prototype.init=function(c,i){this.$block=t(c),this.$checkbox=this.$block.find('[type="checkbox"]'),this.$radio=this.$block.find('[type="radio"]'),this.$checkbox.on("change",t.proxy(this.change,this))},i.prototype.change=function(){this.$radio.prop("checked")||(this.$radio.prop("checked",!0),this.$checkbox.prop("checked",!this.$checkbox.prop("checked")))},t.fn.block_switch=c,t.fn.block_switch.Constructor=i,t(".switch").block_switch()}(jQuery);
$(".join__slider").slick({accessibility:!1,arrows:!0,dots:!1,infinite:!0,slidesToShow:1,slidesToScroll:1});
+function(t){function s(s){return this.each(function(){var o=t(this),r=o.data("block.partners_slider"),e="object"==typeof s&&s;r||o.data("block.partners_slider",r=new i(this,e)),"string"==typeof s&&r[s]()})}var i=function(t,s){this.$block=null,this.init(t,s)};i.prototype.init=function(s,i){this.$block=t(s),this.$block.slick({arrows:!0,dots:!1,infinite:!0,slidesToShow:2,slidesToScroll:2,autoplay:!0,autoplaySpeed:5e3,responsive:[{breakpoint:991,settings:{slidesToShow:1,slidesToScroll:1}}]})},t.fn.block_partners_slider=s,t.fn.block_partners_slider.Constructor=i,t(".partners-list").block_partners_slider()}(jQuery);
!function(e){e.closest=e.closest||function(e){for(var t=this;t;){if(t.matches(e))return t;t=t.parentElement}return null}}(Element.prototype),function(){function e(e){"init"!==e.getAttribute("data-init")&&(e.setAttribute("data-init","init"),e.addEventListener("change",function(e){for(var r,a=e.currentTarget,n=a.files,l=a.closest(".company__property").querySelector(".thumbnails-gallery"),i=l.closest(".modal").getAttribute("id"),o=0!==document.querySelector('[data-target="#'+i+'"]').closest(".company").length?document.querySelector('[data-target="#'+i+'"]').closest(".company").querySelector(".thumbnails-gallery"):document.querySelector('[data-target="#'+i+'"]').closest(".collapse-section").querySelector(".thumbnails-gallery"),c=l.querySelectorAll(".thumbnails-gallery__item"),u=0;u<c.length;u++)c[u].hasAttribute("image-number")&&l.removeChild(c[u]);if(o){r=o.querySelectorAll(".thumbnails-gallery__item");for(var u=0;u<r.length;u++)o.hasAttribute("image-number")&&o.removeChild(r[u])}for(var u=0;u<n.length;u++){t(l,n[u],o,u)}},!1))}function t(e,t,r,a){var n=document.createElement("figure"),l=document.createElement("a"),i=document.createElement("i"),o=document.createElement("img");n.appendChild(o),l.appendChild(i),n.appendChild(l),n.classList.add("thumbnails-gallery__item"),l.classList.add("remove-item"),l.href="javascript:void(0);",i.classList.add("icomoon","icon","icon-close"),o.classList.add("thumbnails-gallery__image"),n.setAttribute("image-number",a),e.appendChild(n);var c=new FileReader;if(c.onload=function(e){return function(t){e.src=t.target.result}}(o),c.readAsDataURL(t),r){var u=n.cloneNode(!0),s=u.querySelector(".remove-item"),d=u.querySelector(".thumbnails-gallery__image");u.removeChild(s),r.appendChild(u);var m=new FileReader;m.onload=function(e){return function(t){e.src=t.target.result}}(d),m.readAsDataURL(t)}}document.addEventListener("OnDocumentHtmlChanged",function(){for(var t=document.querySelectorAll(".change-button__loader"),r=0;r<t.length;r++)e(t[r])},!1)}();
(function ($) {
  "use strict";
...
$(".collapse").on("shown.bs.collapse hidden.bs.collapse",function(e){var l=$(e.currentTarget),o=l.siblings("button"),s=o.children("i"),a=l.parent(".collapse-section");o.toggleClass("collapse-section__title_expanded"),s.toggleClass("icon-arrow-expand icon-arrow-collapse"),a.toggleClass("collapse-section_expanded")});
/*!
 * typeahead.js 0.11.1
...
+function(i){function s(s){return this.each(function(){var t=i(this),e=t.data("block.images_slider"),l="object"==typeof s&&s;e||t.data("block.images_slider",e=new o(this,l)),"string"==typeof s&&e[s]()})}var o=function(i,s){this.$block=null,this.init(i,s)};o.prototype.init=function(s,o){this.$block=i(s),this.$block.slick({arrows:!0,dots:!1,infinite:!0,slidesToShow:3,slidesToScroll:3,responsive:[{breakpoint:991,settings:{slidesToShow:2,slidesToScroll:2}}]})},i.fn.block_images_slider=s,i.fn.block_images_slider.Constructor=o,i(".images-slider").block_images_slider()}(jQuery);
$.each($("textarea.company__value"),function(){var t=this.offsetHeight-this.clientHeight,e=function(e){$(e).css("height","auto").css("height",e.scrollHeight+t)};$(this).on("keyup input",function(){e(this)}).removeAttr("data-autoresize")});
!function(){document.addEventListener("OnDocumentHtmlChanged",function(){$(".thumbnails-gallery").on("click",".remove-item",function(e){var t=$(this),a=t.parent(),n=t.parents(".thumbnails-gallery"),i=n.find(".thumbnails-gallery__item").index(a),l=n.parents(".modal").attr("id"),r=0!==$('[data-target="#'+l+'"]').parents(".company").length?$('[data-target="#'+l+'"]').parents(".company").find(".thumbnails-gallery"):$('[data-target="#'+l+'"]').parents(".collapse-section").find(".thumbnails-gallery"),m=$('input[type="checkbox"][value="'+t.attr("remove-item-id")+'"]');r.find(".thumbnails-gallery__item").eq(i).remove(),m.prop("checked",!0),a.remove()})},!1)}();
!function(){document.addEventListener("OnDocumentHtmlChanged",function(){if("init"!==$(".tags-input").attr("data-init")&&"undefined"!=typeof TagsArray){var t=$(".tags-input");t.tagsinput({typeaheadjs:{name:"tags",source:function(t){return function(a,e){var n;n=[],substrRegex=new RegExp(a,"i"),$.each(t,function(t,a){substrRegex.test(a)&&n.push(a)}),e(n)}}(TagsArray)}}),t.attr("data-init","init"),$("input").on("beforeItemAdd",function(t){var a=!0;for(var e in TagsArray)TagsArray[e]===t.item&&(a=!1);t.cancel=a}),t.on("itemAdded",function(t){var a=$(this).parents(".modal").attr("id"),e=0!==$('[data-target="#'+a+'"]').parents(".company").length?$('[data-target="#'+a+'"]').parents(".company").find("[data-tags]"):$('[data-target="#'+a+'"]').parents(".collapse-section").find("[data-tags]"),n=document.createElement("a");0!==e.children().length?n.textContent=", "+t.item:n.textContent=t.item,n.classList.add("a"),n.setAttribute("href","#"),e[0].appendChild(n)})}},!1)}();
!function(){var n=document,r=["OnDocumentHtmlChanged","DOMContentLoaded"];!function(n,r,t){for(var e=0;e<r.length;e++)n.addEventListener(r[e],t,!1)}(n,r,function(){$(".textarea-scrollbar").scrollbar(),$(".scrollbar-inner").scrollbar()})}();
