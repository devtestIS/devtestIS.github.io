module.exports = {
  ...
  "levels": [
    ...
    },
    {
      ...
      "bem/blocks.04.1-typography",
      "bem/blocks.04.2-bootstrap",
      "bem/blocks.04.X-common",
  ...
  "replacements": {
    ...
    'label_color_default': 'label-default',
    'label_color_primary': 'label-primary',
    'label_color_success': 'label-success',
    'label_color_info': 'label-info',
    'label_color_warning': 'label-warning',
    'label_color_danger': 'label-danger',
    ...
    // 'container_fluid_false': 'container',
    ...
    'embed-responsive_ratio_16by9': 'embed-responsive-16by9',
    'embed-responsive_ratio_4by3': 'embed-responsive-4by3',
    'embed-responsive__item': 'embed-responsive-item',

    // Обычные теги - только те, которые не могут быть вставлены через виз. редактор
    //'img': '',
    'img_responsive': 'img-responsive',
    'img_shape_rounded': 'img-rounded',
    'img_shape_circle': 'img-circle',
    'img_shape_thumbnail': 'img-thumbnail'
  }
};
